  ...
  return (
    <section className="py-20 md:py-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-2xl border-2 border-foreground/10 bg-card p-6 shadow-[0_12px_40px_-12px_rgba(0,0,0,0.12)] sm:p-8 md:p-16">
          {/* Background pattern */}
          ...
          <div className="relative mx-auto max-w-2xl text-center">
            ...
            <div className="mt-8 flex w-full max-w-lg flex-col items-stretch justify-center gap-3 sm:mx-auto sm:max-w-none sm:flex-row sm:flex-wrap sm:items-center sm:gap-4">
